...
// GKSTCPLK-1435: Функциональность перенесена в общий модуль гкс_ПодборЛабораторногоАнализа
// в методе ПерезаполнитьОснованиеДвиженияЗапасовПоЛабораторномуАнализу()
...
// GKSTCPLK-1435: Процедура перенесена в общий модуль гкс_ПодборЛабораторногоАнализа
...
Процедура ЗаполнитьКачественныеПоказателиПоЛабораторномуАнализу()
	...
	// GKSTCPLK-1435: Оригинальный код перенесен в общий модуль гкс_ПодборЛабораторногоАнализа
	// Оставлен закомментированным для истории изменений
