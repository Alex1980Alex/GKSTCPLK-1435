...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.РежимЗаписи = РежимЗаписиДокумента.Проведение Тогда
		...
		ОценкаПроизводительностиКлиент.ЗамерВремени("ПроведениеДокумента.Интерактивно.ЗаписьВГрафикПриемкиПЛК", 
		                                            Истина);
	КонецЕсли;
...
Функция ДанныеСтатистикиПоТР()
	...
	Возврат РегистрыСведений.гкс_ГрафикПриемкиПЛК.СтатистикаПоТранспортнымСредствамДляЗаполнения(
                 Новый Структура("НачалоПериода,ТочкаМаршрута", Объект.НачалоПериода, Объект.ТочкаМаршрута));
