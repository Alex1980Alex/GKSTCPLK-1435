...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
	...
	ТипФайловСохраненияПечатныхФорм = ИнтеграцияС1СДокументооборот.ТипФайлаСохраняемойПечатнойФормыПоУмолчанию();
...
Процедура ПередЗаписью(Отказ)
	...
	Если Не ПометкаУдаления И ИнтеграцияС1СДокументооборот.ВерсияСервиса() <> "0.0.0.0" Тогда
		ПроверитьПравила();
	КонецЕсли;
...
Процедура ПроверитьПравила()
	...
	РеквизитыОбъектаИС = Справочники.ПравилаИнтеграцииС1СДокументооборотом.ПолучитьРеквизитыОбъектаИС(ТипОбъектаИС);
