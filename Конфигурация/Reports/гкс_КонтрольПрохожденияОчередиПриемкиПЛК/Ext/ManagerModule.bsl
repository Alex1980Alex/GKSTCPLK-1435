...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "КонтрольПрохожденияОчереди");
	НастройкиВарианта.Наименование = НСтр("ru = 'Контроль прохождения очереди'");
