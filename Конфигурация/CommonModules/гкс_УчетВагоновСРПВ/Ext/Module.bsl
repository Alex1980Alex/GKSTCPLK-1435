...
// GKSTCPLK-1435: Функция перенесена в общий модуль гкс_ПодборЛабораторногоАнализа
// в методе ПолучитьТекстЗапросаДляКомпозитныхПроб()
...
// GKSTCPLK-1435: Функция перенесена в общий модуль гкс_ПодборЛабораторногоАнализа
// в методе ПолучитьТекстЗапросаДляВходногоКонтроля()
// Оставлена для обратной совместимости
