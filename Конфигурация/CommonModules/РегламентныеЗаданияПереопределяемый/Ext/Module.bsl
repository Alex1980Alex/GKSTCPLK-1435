...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	Настройка = Настройки.Добавить();
	Настройка.РегламентноеЗадание = Метаданные.РегламентныеЗадания.ФормированиеСообщенийПоОповещениям;
	Настройка.ФункциональнаяОпция = Метаданные.ФункциональныеОпции.ИспользоватьЭлектроннуюПочтуВШаблонахСообщений;
	...
	// ИнтеграцияWarehouse.
	гкс_ИнтеграцияWarehouse.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	гкс_ИнтеграцияWarehouseСлужебный.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	// Конец ИнтеграцияWarehouse
	
	// ИнтеграцияСРПВ
	гкс_ИнтеграцияСРПВ.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	// Конец ИнтеграцияСРПВ
	
	// ИнтеграцияЭлектроннуюОчередь
	гкс_ЭлектроннаяОчередьСервер.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	// Конец ИнтеграцияЭлектроннуюОчередь
	
	// доп. интеграции
	гкс_ИнтеграцияMFM.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);

	РегламентныеЗаданияЛокализация = гкс_ЛокализацияСервер.МодульЛокализации("РегламентныеЗаданияЛокализация");	
	Если ТипЗнч(РегламентныеЗаданияЛокализация) = Тип("ОбщийМодуль") Тогда
