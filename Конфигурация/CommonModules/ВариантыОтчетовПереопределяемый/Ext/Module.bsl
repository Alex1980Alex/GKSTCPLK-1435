...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
 	...
 	Разделы.Добавить(Метаданные.Подсистемы.гкс_ПриемкаТранспорта, НСтр("ru = 'Отчеты по приемке транспорта'"));
	Разделы.Добавить(Метаданные.Подсистемы.ЭлектроннаяОчередь, НСтр("ru = 'Отчеты по электронной очереди'"));
	Разделы.Добавить(Метаданные.Подсистемы.гкс_Лаборатория, НСтр("ru = 'Отчеты по лаборатории'"));
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(
		Настройки, Метаданные.Отчеты.гкс_ОтчетОВремениОперацийАвтоНаПЛК);
		
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(
		Настройки, Метаданные.Отчеты.гкс_ЗаписиВЭлектроннойОчереди);
		
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(
		Настройки, Метаданные.Отчеты.гкс_ЖурналВзвешивания);
		
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(
		Настройки, Метаданные.Отчеты.гкс_ЖурналВзвешиванияЗПП);	
		
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(
		Настройки, Метаданные.Отчеты.гкс_ОтчетОПриемкеКачества);
		
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(
		Настройки, Метаданные.Отчеты.гкс_ОтчетОВремениОперацийАвтоНаПЛК);	
		
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(
		Настройки, Метаданные.Отчеты.гкс_АнализПредварительнойЗаписи);
		
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(
		Настройки, Метаданные.Отчеты.гкс_КонтрольЗаездаПоЭлектроннойОчереди);
		
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(
		Настройки, Метаданные.Отчеты.гкс_КонтрольПрохожденияОчередиПриемкиПЛК);
		
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(
		Настройки, Метаданные.Отчеты.гкс_Анализ_FCA_DAP);
		
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(
		Настройки, Метаданные.Отчеты.гкс_РеестрОтгрузки);
		
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(
		Настройки, Метаданные.Отчеты.гкс_РеестрПриемки);	
...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	Объекты.Добавить(Метаданные.Документы.гкс_РегистрацияНаПЛК);
	Объекты.Добавить(Метаданные.Документы.гкс_Взвешивание);
	Объекты.Добавить(Метаданные.Документы.гкс_НаправлениеНаРазгрузку);
	Объекты.Добавить(Метаданные.Документы.гкс_ФормированиеНомераПробы);
	Объекты.Добавить(Метаданные.Документы.гкс_ТранспортныйДокумент);
	Объекты.Добавить(Метаданные.Документы.гкс_СпецификацияКДоговоруКонтрагента);
	Объекты.Добавить(Метаданные.Документы.гкс_РеестрНакладныхЗПП3);
	Объекты.Добавить(Метаданные.Документы.гкс_ЛабораторныйАнализ);
	Объекты.Добавить(Метаданные.Документы.гкс_ПриказНаОтпускПродукцииЭлеватораЗПП16);
	Объекты.Добавить(Метаданные.Документы.гкс_НормативнаяСертификацияНоменклатуры);
	Объекты.Добавить(Метаданные.Обработки.гкс_ПриемкаТранспорта);
	Объекты.Добавить(Метаданные.Обработки.гкс_АРМКомпозитныеПробы);
...
Функция ДобавитьКомандуСтруктураПодчиненности(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.ОбщиеФормы.СвязанныеДокументы) Тогда
		...
		КомандаОтчет.Обработчик = "гкс_МенюОтчетыКлиент.СтруктураПодчиненности";
