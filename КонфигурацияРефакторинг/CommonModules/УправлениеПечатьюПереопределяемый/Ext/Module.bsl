...
Процедура ПриОпределенииНастроекПечати(Настройки) Экспорт
	...
	МодульЛокализации = гкс_ЛокализацияСервер.МодульЛокализации("гкс_УправлениеПечатью");
	Если МодульЛокализации <> Неопределено Тогда
		МодульЛокализации.ОпределитьОбъектыСКомандамиПечати(Настройки.ОбъектыПечати);
	КонецЕсли;
...
Процедура ПриПечати(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если ПараметрыПечати.Свойство("АвтоматическаяПечатьЭтикеток")
		И ПараметрыПечати.АвтоматическаяПечатьЭтикеток Тогда
		
		Для каждого ПечатнаяФорма из КоллекцияПечатныхФорм Цикл
			ТабличныйДокумент = ПечатнаяФорма.ТабличныйДокумент;
			ПечатнаяФорма.Экземпляров = ТабличныйДокумент.КоличествоЭкземпляров;
		КонецЦикла;	
	КонецЕсли;	
