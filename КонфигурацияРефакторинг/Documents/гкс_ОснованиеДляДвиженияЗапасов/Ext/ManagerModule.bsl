...
Процедура ПерезаполнитьОснованиеДвиженияЗапасовКомпозит(ЛабораторныйАнализ, Отказ) Экспорт
	...
	Попытка
		...
		Для Каждого ДокументСсылка Из МассивДокументов Цикл
			...
			// Гкс+[GKSTCPLK-1435] Терлецкий АВ 15.01.2025 Оригинальный вызов заменен централизованным механизмом
			// ЗАКОММЕНТИРОВАННЫЙ КОД: Логика была вынесена в общий модуль для исключения дублирования
			// Обеспечивает единообразное поведение перезаполнения во всех местах использования
