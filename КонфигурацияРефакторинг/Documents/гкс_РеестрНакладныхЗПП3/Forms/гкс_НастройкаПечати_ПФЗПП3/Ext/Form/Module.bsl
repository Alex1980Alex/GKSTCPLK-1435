...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КлючОбъекта = Документы.гкс_РеестрНакладныхЗПП3.КлючОбъектаПользовательскихНастроек();
	КлючНастроек = "НастройкиПечатиРеестраЗПП3";
...
Функция НастройкиПечатиПоУмолчанию()
	...
	Возврат Документы.гкс_РеестрНакладныхЗПП3.НастройкиПечатиПоУмолчанию();
