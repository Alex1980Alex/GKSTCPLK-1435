...
Функция ДанныеДокументаДляПроведения(Документ, Регистры, ДопПараметры = Неопределено) Экспорт
	...
	Если НЕ ДопПараметры.ПолучитьТекстыЗапроса Тогда
		...
		ТекстЗапросаТаблицаГрафикОтгрузкиПЛК(ТекстыЗапроса, Регистры);	
	КонецЕсли;
...
Процедура ТекстЗапросаТаблицаГрафикОтгрузкиПЛК(ТекстыЗапроса, Регистры)
	
	ИмяРегистра = "гкс_ГрафикОтгрузкиПЛК";
	...
	|ИЗ
	|	Документ.гкс_ЗаписьВГрафикОтгрузкиПЛК КАК ДокументЗаписи
	|ГДЕ
